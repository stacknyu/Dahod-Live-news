...
import 'package:news_flutter/videoPlayer/chewie_progress_colors.dart';
import 'package:news_flutter/videoPlayer/cupertino_progress_bar.dart';
    ...
    if (_latestValue!.hasError) {
      return chewieController!.errorBuilder != null
          ? chewieController!.errorBuilder!(
              context,
              chewieController!.videoPlayerController!.value.errorDescription.validate(),
            )
          : Center(
              child: Icon(
                SimpleLineIcons.ban,
