...
class AvatarUrls {
  String? avatarTwentyFour;
  String? avatarFortyEight;
  String? avatarNinetySix;

  AvatarUrls({this.avatarTwentyFour, this.avatarFortyEight, this.avatarNinetySix});

  factory AvatarUrls.fromJson(Map<String, dynamic> json) {
    return AvatarUrls(
      avatarTwentyFour: json['24'],
      avatarFortyEight: json['48'],
      avatarNinetySix: json['96'],
    );
  }

  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    data['24'] = this.avatarTwentyFour;
    data['48'] = this.avatarFortyEight;
    data['96'] = this.avatarNinetySix;
    return data;
  }
}
